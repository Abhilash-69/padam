...
app.get("/api/m/:movie_name",async (req,res)=>{
    ...
    if(resp.rowCount===0){
        ...
        console.log(movie_name,crew.actorName,crew.characterName,crew.imageUrl)
        ...
        const c = await db.query("insert into crew(m_id,c_name,char_role,cc_image) values($1,$2,$3,$4) RETURNING *",[movie_name,crew.actorName,crew.characterName,crew.imageUrl]);
        res.json(s.rows[0])
    }
    else{
        console.log(resp.rowCount)
